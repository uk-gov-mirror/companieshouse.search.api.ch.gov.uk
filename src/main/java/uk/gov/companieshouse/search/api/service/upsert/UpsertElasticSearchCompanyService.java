...
public class UpsertElasticSearchCompanyService implements UpsertCompanyService {
    ...
    public UpsertElasticSearchCompanyService(
    ...
    public ResponseObject<String> upsert(CompanyProfileApi company) {
        Map<String, Object> logMap = new DataMap.Builder()
                ...
                .build().getLogMap();
        getLogger().info("ElasticSearch Upserting company underway", logMap);
        ...
        try {
            ...
            getLogger().error("An error occured attempting upsert the document on ElasticSearch", logMap);
        ...
        try {
            ...
            getLogger().error("IOException when upserting company on ElasticSearch", logMap);
            return new ResponseObject<>(ResponseStatus.UPDATE_REQUEST_ERROR);
        }

        getLogger().info("ElasticSearch Upsert successful for ", logMap);
