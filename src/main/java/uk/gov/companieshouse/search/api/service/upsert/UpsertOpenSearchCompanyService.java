...
import uk.gov.companieshouse.search.api.service.upsert.alphabetical.AlphabeticalOpenSearchUpsertRequestService;
...
public class UpsertOpenSearchCompanyService implements UpsertCompanyService {
    ...
    private final AlphabeticalOpenSearchUpsertRequestService alphabeticalUpsertRequestService;
    ...
    public UpsertOpenSearchCompanyService(
            AlphabeticalOpenSearchRestClientService alphabeticalSearchRestClientService,
        AdvancedSearchRestClientService advancedSearchRestClientService,
            AlphabeticalOpenSearchUpsertRequestService alphabeticalUpsertRequestService,
    ...
    public ResponseObject<String> upsert(CompanyProfileApi company) {
        ...
        org.opensearch.client.opensearch.core.UpdateRequest updateRequest;
